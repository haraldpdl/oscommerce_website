...
class GetPartnerPackageLevelsExtra
{
    public static function execute($data)
    {
        ...
        if (isset($data['language_id'])) {
            ...
            $sql = 'select l.id, l.duration_months, l.price, l.default_selected, ll.title from :table_website_partner_package_levels l, :table_website_partner_package_levels_lang ll, :table_website_partner_package p where p.code = :package_code and p.id = l.package_id and l.status = 1 and l.partner_id = :partner_id and l.id = ll.id and ll.languages_id = :default_language_id order by l.sort_order, ll.title';
        }
