...
EOD;
        ...
        $Qpartners->bindValue(':category_code', $data['code']);
        ...
        $Qpartners->setCache('website_partners-' . $data['code'] . '-lang' . ($data['language_id'] ?? $data['default_language_id']), 720);
        $Qpartners->execute();
