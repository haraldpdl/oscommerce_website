...
/* Open Graph */
        ...
        $OSCOM_Template->addHtmlElement('header', '<meta property="article:author" content="http://forums.oscommerce.com/index.php?showuser=' . HTML::outputProtected($news_entry['author_id']) . '" />');
