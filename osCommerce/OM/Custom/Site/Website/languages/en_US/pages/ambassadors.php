...
<p>An invoice for the purchase will be available within a few minutes. An email will be sent out as soon as the invoice has been added to your account area.</p>
...
verify_introduction = A verification email has just been sent to you at <span id="ambVerifyEmailAddress" style="font-weight: bold;"></span>. Please fill in the following with the ID and Key sent to you.

verify_user_id_title = Verification ID
verify_user_id_js_error = Please use the ID from the verification email sent to you.

verify_key_title = Verification Key
verify_key_js_error = Please use the Key from the verification email sent to you. This must be 32 characters long.
...
billing_address_introduction = A billing address is needed for your invoice.

billing_firstname_title = First Name
billing_firstname_js_error = Required

billing_lastname_title = Last Name
billing_lastname_js_error = Required

billing_street_address_title = Street Address
billing_street_address_js_error = Required

billing_street_address2_title = (Apt, Suite, <span class="d-none d-lg-inline">Building,</span> etc)
...
billing_country_js_error = Required
...
payment_processing_button_title = <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Processing..
