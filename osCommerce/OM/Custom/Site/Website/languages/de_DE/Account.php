...
login_introduction = <p class="lead">Melden Sie sich an und nehmen Sie an unserer Community teil.</p>

login_username_title = Benutzername
login_username_js_error_required = Erforderlich
login_username_js_error_short = Der Benutzername ist zu kurz
login_username_js_error_long = Der Benutzername ist zu lang
login_username_ms_error_short = Ihr Benutzername ist zu kurz.
login_username_ms_error_long = Ihr Benutzername ist zu lang.

login_password_title = Passwort
login_password_forgotten_link = Passwort vergessen?
login_password_js_error_required = Erforderlich
login_password_js_error_short = Das Passwort ist zu kurz
login_password_js_error_long = Das Passwort ist zu lang
login_password_ms_error_short = Ihr Passwort ist zu kurz.
login_password_ms_error_long = Ihr Passwort ist zu lang.

login_remember_me_title = Anmeldung speichern
login_remember_me_note = Anmeldung auf öffentlichen Geräten sind nicht empfehlenswert

login_button_title = Anmelden
login_processing_button_title = <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> in Bearbeitung..
...
create_html_title = Konto erstellen | osCommerce
create_title = Konto erstellen

create_introduction = <p class="lead">Erstellen Sie ein Benutzerkonto und nehmen Sie an unserer Community teil.</p>

create_username_title = Benutzername
create_username_note = Zwischen 3 und 26 Zeichen
create_username_js_error_required = Erforderlich
create_username_js_error_short = Der Benutzername ist zu kurz
create_username_js_error_long = Der Benutzername ist zu lang
create_username_js_error_oscommerce = "osCommerce" ist nicht erlaubt
create_username_ms_error_short = Ihr Benutzername ist zu kurz.
create_username_ms_error_long = Ihr Benutzername ist zu lang.
create_username_ms_error_oscommerce = Ihr Benutzername darf "osCommerce" nicht enthalten.
create_username_ms_error_email = Your username cannot contain an email address.
create_username_ms_error_exists = Ihr Benutzername ist auf ein Konto schon zugeteilt.

create_email_address_title = Email Adresse
create_email_address_js_error_required = Erforderlich
create_email_address_js_error_invalid = Die email Adresse ist nicht gültig
create_email_address_ms_error_required = Ihre email Adresse ist erforderlich.
create_email_address_ms_error_invalid = Ihre email Adresse ist ungültig.
create_email_address_ms_error_exists = Ihre email Adresse ist auf ein Konto schon zugeteilt.

create_password_title = Neues Passwort
create_password_note = Zwischen 3 und 32 Zeichen
create_password_js_error_required = Erforderlich
create_password_js_error_short = Das Passwort ist zu kurz
create_password_js_error_long = Das Passwort ist zu lang
create_password_ms_error_short = Ihr Passwort ist zu kurz.
create_password_ms_error_long = Ihr Passwort ist zu lang.

create_security_check_title = Sicherheitskontrolle
create_security_check_js_error = Erforderlich
...
create_tos_agree = Mit Ihrer Registrierung willigen Sie und stimmen unsere <a href="{link}Us|Website|Legal#PrivacyPolicy{link}" target="_blank">Datenschutzerklärung</a> und <a href="{link}Us|Website|Legal#TermsOfUsePolicy{link}" target="_blank">Nutzungsbedingungen</a> ein.

create_button_title = Konto erstellen
create_processing_button_title = <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> in Bearbeitung..

create_return_to_forum = or return back to the forum

create_after_creation_title = Was passiert nach der Erstellung meines Kontos?
create_after_creation_content = <p>Nach der Erstellung Ihres Kontos erhalten Sie eine email mit einem Bestätigungslink, mit dem Sie Ihr Konto bestätigen und vervollständigen müssen.</p>

create_email_new_account_subject = osCommerce Benutzerkonto

create_ms_success = Ihr Konto ist erstellt! Bitte prüfen Sie Ihre email für weitere Anweisungen wie Sie Ihr Konto Verifizieren können.
create_ms_error_general = Ihr Konto kann zur Zeit nicht erstellt werden. Bitte Kontaktieren Sie uns um dieses Problem zu lösen.
...
verify_html_title = Konto Verifizieren | osCommerce
verify_title = Konto Verifizieren

verify_introduction = <p class="lead">Bitte folgen Sie den Anweisungen die Ihnen in einer email zugeschickt worden ist um Ihr Konto zu Verifizieren.</p>

verify_user_id_title = Verifizierungs-ID
verify_user_id_js_error_required = Erforderlich
verify_user_id_js_error_invalid = Die Verifizierungs-ID ist ungültig. Die Verifizierungs-ID besteht aus Nummern - bitte prüfen Sie dies mit der Verifizierungs-ID, dass Sie per email erhalten haben.
verify_user_id_ms_error_invalid = Ihre Verifizierungs-ID ist ungültig. Die Verifizierungs-ID besteht aus Nummern - bitte prüfen Sie dies mit der Verifizierungs-ID, dass Sie per email erhalten haben.

verify_key_title = Verifizierungs-Schlüssel
verify_key_js_error_required = Erforderlich
verify_key_js_error_length = Besteht aus 32 Zeichen
verify_key_js_error_invalid = Der Verifizierungs-Schlüssel ist ungültig. Der Verifizerungs-Schlüssel besteht aus 32 Zeichen - bitte prüfen Sie dies mit dem Verifizierungs-Schlüssel, dass Sie per email erhalten haben.
verify_key_ms_error_invalid = Ihr Verifizierungs-Schlüssel ist ungültig. Der Verifizerungs-Schlüssel besteht aus 32 Zeichen - bitte prüfen Sie dies mit dem Verifizierungs-Schlüssel, dass Sie per email erhalten haben.

verify_button_title = Konto Verifizieren
verify_processing_button_title = <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> in Bearbeitung..
...
partner_no_sites_to_add_to_showcase = Momentan sind keine Seiten in Ihrer Shop Galerie vorhanden.
...
partner_field_billing_vat_id_title = USt-ID
partner_field_billing_vat_id_note = Falls vorhanden, EU erforderlich
...
cs_pay_credit_card_button = Zahlen #amount#
cs_pay_processing_button = <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> in Bearbeitung..
